...
const projects: Project[] = [
  {
    ...
    stack: ["HTML", "CSS","BOOTSRAP", "JavaScript", "PHP"],
    outcome: "Manage student informations",
    icon: BookOpen,
    color: "#8b5cf6",
  ...
  },
  {
    ...
    category: "Automation",
    description: "A smart egg sorting machine that detects cracks to separate egg quality.",
    stack: ["Arduino", "Python", "TensorFlow", "Machine Learning"],
    outcome: "Egg segregation and quality control system",
    icon: Scan,
    color: "#eecbc2",
  ...
  },
  {
    ...
    description: "Real-time flood monitoring system using water level sensors and alerts to prevent flood disasters.",
    stack: ["Arduino", "IoT"],
  ...
  },
  {
    ...
    description: "An intelligent waste management system with an auto-opening lid, fill-level detection, and real-time trash bin location tracking on a website.",
    stack: ["Arduino", "IOT", "HTML","CSS","JAVASCRIPT"],
